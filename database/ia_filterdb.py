...
import re
import base64
from pyrogram.raw.types import FileId
...
async def get_search_results(query, file_type=None, max_results=10, offset=0):
    ...
    try:
        ...
        logger.exception('Invalid regular expression')
        return []
    ...
    try:
        ...
        logger.exception('Error occurred while fetching search results')
        return [], 0, 0
...
async def get_file_details(query):
    ...
    try:
        ...
        logger.exception('Error occurred while fetching file details')
        return []
