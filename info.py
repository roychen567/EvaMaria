...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '0'))  # Assuming AUTH_CHANNEL is an integer
AUTH_GROUPS = [int(ch) for ch in environ.get('AUTH_GROUP', '').split()] if environ.get('AUTH_GROUP') else []
...
# Request Fsub
REQ_CHANNEL = int(environ.get("REQ_CHANNEL", "-1002188987730")) if environ.get("REQ_CHANNEL") else None
